...
class LaneNode:
    ...
    def dyn_callback(self, config, level):
        ...
        # Preprocessing (Bilateral & Canny)
        cfg.BILATERAL_D       = config.bilateral_d
        cfg.BILATERAL_COLOR   = config.bilateral_color
        cfg.BILATERAL_SPACE   = config.bilateral_space
        ...
        cfg.MIN_LANE_WIDTH_PX     = config.min_lane_width_px
