...
# ROS 토픽
# ============================================================
IMAGE_TOPIC = "/usb_cam/image_raw"  # 입력 카메라 토픽(실차 기본). sim 모드에서 main.py가 override 가능

# ============================================================
# 카메라 외부 파라미터 (Extrinsic)
# ============================================================
CAMERA_HEIGHT_M  = 1.20  # 카메라 높이[m] (지면~렌즈 중심)
CAMERA_PITCH_DEG = 55.0  # 카메라 하향 피치[deg] (+면 아래를 봄)
...
BEV_WIDTH_M    = 4.0  # BEV 좌우 폭 [m]
BEV_LENGTH_M   = 4.0  # BEV 전방 길이 [m]
...
# ============================================================
# 기초 비전 파라미터 (Preprocessing)
# ============================================================
BILATERAL_D       = 9      # 이웃 픽셀 공간 탐색 반경
BILATERAL_COLOR   = 35     # 색상(명암) 유사도 필터
BILATERAL_SPACE   = 35     # 공간 거리 가중치 필터

CANNY_LOW  = 50   # 낮으면 노이즈↑, 높으면 약한 차선 누락↑
CANNY_HIGH = 120  # 낮/밤/노면 대비에 따라 함께 튜닝
...
# ============================================================
TRACK_MARGIN        = 70    # 이전 fit 주변 탐색 폭 — 하단(가까움) (px)
TRACK_MARGIN_TOP    = 70    # 이전 fit 주변 탐색 폭 — 상단(먼거리) (px) — 커브 시 옆차선 혼입 방지
...
SINGLE_SIDE_OFFSET_M  = 0.80    # 한쪽 차선만 보일 때 중심선 오프셋 [m]
